 ...
 * @summary Central API configuration matching backend routes
 */
...
/**
 * @client publicClient
 * @summary Client for public endpoints (no auth required)
 */
 ...
 * @summary Client for internal endpoints (auth required)
 */
